...
/*   Updated: 2023/02/19 13:43:02 by gamaral          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//start with 'A' and if x>1, print x-1 chars with 'B', and end with 'A'
//if y > 1, print B, print x-1 ' ', and end with 'B'
//end with 'C' and if x>1, print x-1 chars with 'B', and end with 'C'
